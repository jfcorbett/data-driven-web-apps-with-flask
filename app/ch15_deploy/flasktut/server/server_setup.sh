...
cp /apps/app_repo/app/ch15_deploy/flasktut/server/pypi.service /etc/systemd/system/pypi.service

systemctl start pypi
systemctl status pypi
systemctl enable pypi  # daemon will restart automatically after reboot
...
cp /apps/app_repo/app/ch15_deploy/flasktut/server/pypi.nginx /etc/nginx/sites-enabled/pypi.nginx
